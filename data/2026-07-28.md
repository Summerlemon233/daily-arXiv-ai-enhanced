...
### [1] [Fast Iterative Dual-Output-Aware LUT Mapping for Fracturable FPGA Architectures](https://arxiv.org/abs/2607.22756)
*Sheng Lu*
...
### [2] [Benchmarking LLMs for Verilog Design Flows](https://arxiv.org/abs/2607.22759)
...
### [3] [DRC-Aid: Design-Rule Correction via Agentic Framework utilizing Inference-Time Large Language Models](https://arxiv.org/abs/2607.22761)
...
### [4] [FusionML: Prefill, Not Decode - Mechanism and Boundaries of CPU+GPU Co-Execution on Unified-Memory Apple Silicon](https://arxiv.org/abs/2607.22785)
*Om Mohite*
...
### [5] [The Sparsity Tax: Weight Sparsity Trade-offs in Event-Driven SIMD and SIMT Neuromorphic Cores](https://arxiv.org/abs/2607.22790)
...
### [6] [Reducing Instruction-Fetch Energy in RISC-V for Embedded AI Processing via Dynamic and Static Loop Caching](https://arxiv.org/abs/2607.22792)
...
### [7] [Multi-primitive in-memory computing for Monte Carlo tree search](https://arxiv.org/abs/2607.22869)
...
### [8] [Magnetic Tunnel Junctions for Timekeeping in Intermittent Computing Systems](https://arxiv.org/abs/2607.23000)
...
### [9] [Decoding the Skew: Distribution-Aware MoE Inference with Adaptive Kernel Dispatch](https://arxiv.org/abs/2607.23099)
...
### [10] [Characterizing Warp Divergence from Pascal to Blackwell](https://arxiv.org/abs/2607.23402)
*Alpin Dale*
...
### [11] [CircuitWeave: Topology-Behavior Alignment for Executable Multimodal RTL Generation](https://arxiv.org/abs/2607.23523)
...
### [12] [PIMID: A Full-System Simulator with Intricacy and Diversity for Processing-in-Memory](https://arxiv.org/abs/2607.24196)
...
### [13] [DICE: Detailed Inter-Chiplet End-to-End PHY Modeling for Accurate Chiplet Simulation](https://arxiv.org/abs/2607.24221)
...
### [14] [A Heterogeneous Neural Network Accelerator for End-to-End Multitask RF Signal Recognition](https://arxiv.org/abs/2607.24669)
